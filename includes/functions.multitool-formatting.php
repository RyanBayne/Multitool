<?php
/**
 * Multitool - Data Formatting Functions
 *
 * @author   Ryan Bayne
 * @category Core
...
* @version 1.0
*/
function multitool_string_half( $string, $ret = null ) {        
    $a = array();
 ...
 */
function multitool_normalize_postcode( $postcode ) {          
 ...
 * @return string
 */
function multitool_format_phone_number( $tel ) {            
 ...
 * @return string
 */
function multitool_strtolower( $string ) {                    
 ...
 * @return string
 */
function multitool_trim_string( $string, $chars = 200, $suffix = '...' ) {      
 ...
 * @return string|array
 */
function multitool_clean( $var ) {
    if ( is_array( $var ) ) {
        return array_map( 'multitool_clean', $var );
    } else {
