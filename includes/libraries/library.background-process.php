...
if ( ! class_exists( 'Multitool_Background_Process' ) ) {
     ...
     */
    abstract class Multitool_Background_Process extends Multitool_Async_Request {
        ...
        public function schedule_cron_healthcheck( $schedules ) {
            ...
            $schedules[ $this->identifier . '_cron_interval' ] = array(
                ...
                'display'  => sprintf( __( 'Every %d Minutes', 'multitool' ), $interval ),
            );
