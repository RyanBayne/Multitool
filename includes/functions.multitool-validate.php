<?php
/**
 * Multitool - Validation Functions
 *
...
* @return boolean 
*/
function multitool_is_extensionloaded( $giving_extension ){      
...
* @returns boolean
*/
function multitool_is_decimalnumber( $img_url){       
...
* @returns boolean
*/
function multitool_is_image_url( $img_url ){       
