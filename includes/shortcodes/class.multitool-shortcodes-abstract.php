...
if ( ! class_exists( 'Multitool_Shortcode' ) ) :
       
abstract class Multitool_Shortcode extends Multitool_Codec_Instance {
    ...
    public function register ($key) {
        ...
        add_action('multitool-shortcodes-shortcode_help', array($this, "add_shortcode_help"));
        add_filter('multitool-shortcodes-shortcode_help-string', array($this, 'get_shortcode_help'));
    }
