<?php
/**
 * Multitool - Santization Functions
 *
 * @author   Ryan Bayne
 * @category Security
 ...
 * @return string
 */
function multitool_sanitize_taxonomy_name( $taxonomy ) {
 ...
 *
 * Cannot use multitool_clean because it sometimes strips % chars and breaks the user's setting.
 *
 * @param  string $value
 * @return string
 */                                              
function multitool_sanitize_permalink( $value ) {       
    global $wpdb;
 ...
 * @return string
 */
function multitool_sanitize_tooltip( $var ) { 
